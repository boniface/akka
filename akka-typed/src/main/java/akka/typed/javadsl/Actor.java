...
public abstract class Actor {
  ...
  /**
   * Mode selector for the `restarter()` wrapper that decides whether an actor
   ...
   * 
   * @param signal
   *          procedure to invoke with the [[ActorContext]] and the
   *          [[akka.typed.Signal]] as arguments before delivering the signal to
   *          the wrapped behavior
   * @param message
   *          procedure to invoke with the [[ActorContext]] and the received
